...
#pragma simd
  for (int n = 0; n < NN; ++n)
...
#ifdef DEBUG
      std::cout << "curvature=" << 1.f/invcurvature << std::endl;
#endif
...
#ifdef DEBUG
	     std::cout << "r0=" << r0 << " r0inv=" << 1.f/r0 << " pt=" << pt << std::endl;
#endif
	...
	<< std::endl;
      ...
      errorProp(n,0,0) = 1.f + k*dTPdx*(pxin*cosTP - pyin*sinTP);	//dxdx;
      ...
      errorProp(n,1,1) = 1.f + k*dTPdy*(pyin*cosTP + pxin*sinTP);	//dydy;
      errorProp(n,1,2) = 0.f;
