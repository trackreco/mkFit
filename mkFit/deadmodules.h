deadvectors[4].push_back({1.20385,1.45785,-50.5788,-38.8903});
deadvectors[4].push_back({1.44553,1.69953,-9.5373,2.15122});
deadvectors[5].push_back({-2.44046,-2.14285,-30.3916,-18.1481});
...
deadvectors[4].push_back({-0.246117,0.00788592,-9.53809,2.15041});
deadvectors[5].push_back({0.393076,0.658222,-45.6073,-33.3638});
...
deadvectors[5].push_back({2.27802,2.54316,-22.1413,-9.89781});
deadvectors[5].push_back({2.69692,2.96206,-45.6071,-33.3637});
deadvectors[4].push_back({-2.72661,-2.50429,-45.3314,-33.6429});
deadvectors[4].push_back({-2.09829,-1.87597,-66.3891,-54.7006});
deadvectors[5].push_back({-1.4919,-1.22675,-66.6664,-54.4229});
deadvectors[4].push_back({-0.84172,-0.619388,-45.3323,-33.6438});
deadvectors[5].push_back({-0.444701,-0.179556,-66.6676,-54.4241});
deadvectors[4].push_back({-0.422784,-0.200452,-66.3883,-54.6997});
deadvectors[4].push_back({-0.00445457,0.249553,31.5671,43.2556});
deadvectors[5].push_back({2.39277,2.69036,10.7877,23.0312});
deadvectors[4].push_back({2.89548,-3.1337,31.5691,43.2576});
...
deadvectors[5].push_back({1.02138,1.28653,24.9675,37.211});
deadvectors[4].push_back({2.50938,2.73171,48.6308,60.3193});
deadvectors[4].push_back({2.92826,-3.1326,48.6308,60.3193});
deadvectors[4].push_back({3.1377,-2.92317,48.631,60.3195});
deadvectors[4].push_back({-2.72662,-2.50429,1.73323,13.4217});
deadvectors[4].push_back({-2.51722,-2.2949,48.6315,60.32});
deadvectors[5].push_back({-2.1202,-1.85506,24.9671,37.2106});
...
deadvectors[4].push_back({-1.05111,-0.828781,1.73339,13.4219});
deadvectors[4].push_back({-0.213349,0.0089756,1.7314,13.4199});
...
deadvectors[6].push_back({2.58631,2.77446,-23.8673,-12.1788});
deadvectors[7].push_back({2.75624,2.9774,-65.8861,-53.6427});
deadvectors[7].push_back({-0.93975,-0.718593,-65.8865,-53.6431});
deadvectors[6].push_back({-0.740066,-0.551915,-65.609,-53.9204});
deadvectors[7].push_back({-0.570145,-0.348989,-24.1455,-11.902});
deadvectors[7].push_back({-0.570138,-0.348984,-45.049,-32.8056});
deadvectors[7].push_back({-0.385339,-0.164182,-24.1443,-11.9008});
deadvectors[6].push_back({-0.370478,-0.182329,-23.865,-12.1764});
deadvectors[6].push_back({-0.370473,-0.182326,-44.7698,-33.0813});
deadvectors[6].push_back({-0.370477,-0.182327,-65.6096,-53.921});
deadvectors[7].push_back({-0.200542,0.0206133,-24.1426,-11.8991});
deadvectors[6].push_back({-0.185663,0.00248351,-23.8681,-12.1795});
deadvectors[7].push_back({-0.200552,0.0206063,-45.0477,-32.8042});
deadvectors[7].push_back({-0.200555,0.0205994,-65.885,-53.6416});
deadvectors[7].push_back({0.478463,0.681132,-60.7588,-48.5153});
deadvectors[7].push_back({1.63588,1.83855,-60.757,-48.5136});
deadvectors[7].push_back({1.80124,2.00391,-37.6589,-25.4155});
deadvectors[7].push_back({-2.00175,-1.79908,-60.7592,-48.5157});
deadvectors[7].push_back({-0.844309,-0.641639,-60.7585,-48.515});
...
deadvectors[7].push_back({1.27785,1.49901,38.6509,50.8943});
deadvectors[6].push_back({1.29273,1.48088,38.93,50.6185});
deadvectors[6].push_back({1.47751,1.66566,38.9277,50.6162});
...
deadvectors[7].push_back({-0.754947,-0.533792,17.7664,30.0098});
deadvectors[6].push_back({-0.185671,0.00247511,-2.90681,8.7817});
deadvectors[6].push_back({0.825892,0.996145,9.01813,20.7082});
...
deadvectors[7].push_back({-0.348281,-0.145614,31.8941,44.1375});
deadvectors[8].push_back({0.139836,0.29041,-51.4629,-39.7744});
...
deadvectors[8].push_back({0.568229,0.718801,-30.4697,-18.7812});
deadvectors[8].push_back({1.28223,1.4328,-30.4708,-18.7823});
deadvectors[8].push_back({1.56783,1.7184,-51.4633,-39.7748});
...
deadvectors[8].push_back({-1.71656,-1.56599,-9.45355,2.23499});
...
deadvectors[8].push_back({-1.91307,-1.77347,-21.0845,-9.39599});
deadvectors[8].push_back({-0.956922,-0.817325,-21.0853,-9.39678});
deadvectors[8].push_back({-0.00296708,0.147604,11.575,23.2636});
...
deadvectors[8].push_back({1.71062,1.86119,11.575,23.2637});
...
deadvectors[8].push_back({1.85341,2.00402,32.5815,44.2709});
deadvectors[8].push_back({1.85343,2.00401,53.5485,65.2371});
...
deadvectors[8].push_back({1.77488,1.91448,1.61489,13.3036});
...
deadvectors[9].push_back({1.68042,1.79871,54.6987,66.3926});
deadvectors[9].push_back({1.79276,1.91081,9.14224,20.8309});
deadvectors[9].push_back({1.79276,1.91084,31.9357,43.6243});
...
deadvectors[9].push_back({-2.91966,-2.80159,31.9356,43.6245});
deadvectors[9].push_back({-2.02203,-1.90398,54.7031,66.3917});
...
deadvectors[49].push_back({-3.03014,-2.72619,22.9885,34.8762});
...
deadvectors[48].push_back({-0.918437,-0.652351,32.587,41.4818});
...
deadvectors[50].push_back({-0.394842,-0.128742,23.3362,34.5209});
...
deadvectors[52].push_back({-0.133043,0.133055,23.3367,34.5215});
deadvectors[52].push_back({-0.708694,-0.547934,39.3374,50.4393});
deadvectors[22].push_back({0.631782,0.93575,22.9876,34.8754});
...
deadvectors[22].push_back({0.903453,1.19207,32.1235,41.9466});
deadvectors[22].push_back({-1.19094,-0.902324,32.1231,41.9462});
deadvectors[21].push_back({-1.18023,-0.914154,32.5873,41.4819});
...
deadvectors[23].push_back({0.862097,1.02286,39.3359,50.4378});
deadvectors[26].push_back({2.46438,2.76835,22.9878,34.8757});
...
deadvectors[13].push_back({1.26454,1.42884,-55.7035,-36.2477});
deadvectors[13].push_back({1.78682,1.95377,-108.709,-89.2535});
deadvectors[13].push_back({-0.957066,-0.800138,-91.9703,-72.5145});
deadvectors[13].push_back({-0.568052,-0.403767,-91.9695,-72.5139});
deadvectors[12].push_back({-0.293672,-0.154556,-36.6209,-18.0074});
deadvectors[12].push_back({0.22995,0.369059,71.1616,89.7752});
...
deadvectors[13].push_back({1.39913,1.55606,53.6555,73.1111});
deadvectors[13].push_back({2.96875,3.1281,-0.498503,18.9573});
deadvectors[13].push_back({2.96872,3.12807,35.3365,54.7923});
deadvectors[12].push_back({-2.51578,-2.38298,71.1646,89.7781});
deadvectors[13].push_back({-1.74245,-1.58552,53.6557,73.1115});
deadvectors[12].push_back({-0.293645,-0.154534,71.1633,89.7769});
deadvectors[14].push_back({0.166429,0.288434,-36.623,-18.0096});
...
deadvectors[14].push_back({0.750168,0.868263,-89.7765,-71.163});
deadvectors[14].push_back({1.68148,1.79861,-36.6218,-18.0082});
...
deadvectors[14].push_back({2.26082,2.38282,-36.6214,-18.0079});
deadvectors[14].push_back({2.37961,2.49674,-36.6227,-18.0092});
deadvectors[14].push_back({2.49301,2.61606,-18.5374,0.0760317});
deadvectors[14].push_back({-2.74,-2.62287,-72.6904,-54.077});
deadvectors[14].push_back({-2.39338,-2.27138,-108.289,-89.6755});
...
deadvectors[14].push_back({-1.46306,-1.34001,-54.3708,-35.7574});
deadvectors[14].push_back({-2.50731,-2.39018,36.6692,55.2826});
...
deadvectors[15].push_back({0.181867,0.292207,-72.6915,-54.0777});
...
deadvectors[16].push_back({1.14693,1.24207,-72.6916,-54.0781});
deadvectors[16].push_back({2.95412,3.05246,-108.289,-89.6751});
...
deadvectors[16].push_back({0.575389,0.671193,89.6723,108.286});
deadvectors[16].push_back({2.0018,2.10082,18.0092,36.6226});
deadvectors[16].push_back({2.19253,2.29087,72.9356,91.549});
deadvectors[16].push_back({3.05091,-3.13713,36.6682,55.2816});
deadvectors[16].push_back({-0.853865,-0.755523,72.9352,91.5488});
deadvectors[16].push_back({-0.757371,-0.661593,89.675,108.288});
deadvectors[17].push_back({0.659162,0.747458,-36.6215,-18.008});
...
deadvectors[17].push_back({-2.39725,-2.30949,-91.5497,-72.9363});
...
deadvectors[17].push_back({-0.0198351,0.0679261,18.0107,36.6245});
deadvectors[17].push_back({2.01769,2.10599,35.7591,54.3727});
deadvectors[17].push_back({2.2737,2.35942,35.7609,54.3745});
deadvectors[17].push_back({2.69722,2.78498,89.6738,108.288});
deadvectors[54].push_back({1.04512,1.31125,23.7184,32.311});
deadvectors[54].push_back({-2.71057,-2.63012,88.8939,109.382});
deadvectors[55].push_back({-2.1115,-1.81599,23.3724,32.6576});
deadvectors[54].push_back({-2.13313,-2.01826,50.5016,62.0367});
deadvectors[55].push_back({-1.89756,-1.71687,60.0176,75.7975});
deadvectors[55].push_back({-1.32254,-1.03379,32.1179,41.9458});
deadvectors[54].push_back({-0.237453,-0.0766946,39.3382,50.4401});
deadvectors[55].push_back({2.0773,2.37278,23.3725,32.6569});
deadvectors[54].push_back({-1.68433,-1.56947,50.5035,62.0386});
deadvectors[56].push_back({0.233782,0.394539,39.3381,50.44});
deadvectors[56].push_back({0.223108,0.337983,50.5017,62.037});
deadvectors[56].push_back({1.23286,1.34772,50.5041,62.0392});
deadvectors[56].push_back({2.80366,2.91851,72.7925,91.2319});
deadvectors[56].push_back({2.63013,2.71057,88.8928,109.381});
...
deadvectors[56].push_back({-1.31113,-1.0451,32.5951,41.4897});
deadvectors[56].push_back({-1.12332,-1.00847,72.7904,91.2296});
deadvectors[56].push_back({-0.337926,-0.223083,72.7966,91.2361});
deadvectors[57].push_back({-0.017101,0.278413,23.373,32.6583});
deadvectors[57].push_back({0.771853,1.06056,32.1221,41.9492});
deadvectors[56].push_back({3.02283,3.10328,88.8976,109.386});
deadvectors[56].push_back({-0.898917,-0.784081,72.7988,91.238});
deadvectors[58].push_back({1.25536,1.41498,60.5166,75.2901});
deadvectors[58].push_back({-1.31115,-1.04502,23.7167,32.3089});
deadvectors[58].push_back({-3.02471,-2.94427,88.8997,109.388});
deadvectors[58].push_back({-3.10329,-3.02285,88.8991,109.387});
deadvectors[59].push_back({-1.84971,-1.5542,23.3727,32.6578});
deadvectors[60].push_back({1.04506,1.31113,32.5875,41.4822});
deadvectors[60].push_back({-0.562317,-0.447456,50.505,62.0401});
deadvectors[61].push_back({2.08086,2.36957,32.1218,41.9491});
deadvectors[60].push_back({-0.898921,-0.784064,72.7894,91.2291});
deadvectors[63].push_back({0.248258,0.536982,32.1221,41.9502});
deadvectors[62].push_back({0.259671,0.525741,32.5886,41.4833});
deadvectors[63].push_back({-0.640917,-0.460211,60.0161,75.7966});
deadvectors[62].push_back({-0.118763,-0.0383248,88.8979,109.386});
deadvectors[62].push_back({-3.02473,-2.94428,88.8892,109.378});
deadvectors[62].push_back({-1.02285,-0.862085,39.3357,50.4376});
deadvectors[62].push_back({-0.904167,-0.823708,88.8936,109.383});
deadvectors[64].push_back({-2.04331,-1.88368,60.5152,75.2887});
deadvectors[65].push_back({-1.32251,-1.03379,32.1215,41.9492});
deadvectors[64].push_back({-1.2183,-1.13786,88.8978,109.386});
deadvectors[64].push_back({-0.237447,-0.0766812,39.3358,50.4377});
...
deadvectors[64].push_back({-0.668537,-0.588086,88.8938,109.382});
...
deadvectors[66].push_back({-3.02473,-2.94429,88.8967,109.385});
deadvectors[66].push_back({-2.58194,-2.46706,50.499,62.0343});
...
deadvectors[68].push_back({-2.04332,-1.88368,60.5141,75.2876});
deadvectors[69].push_back({-2.21171,-2.03102,60.0189,75.7993});
deadvectors[68].push_back({-1.90872,-1.79387,72.7952,91.2346});
deadvectors[68].push_back({-0.0013158,0.113557,50.4989,62.034});
deadvectors[68].push_back({-0.113513,0.00132563,72.7967,91.2359});
deadvectors[68].push_back({1.33333,1.49413,39.3281,50.4303});
deadvectors[68].push_back({1.45202,1.53246,88.8983,109.386});
deadvectors[68].push_back({-2.59367,-2.43289,39.3326,50.4345});
deadvectors[69].push_back({-0.797983,-0.617291,60.0173,75.7973});
...
deadvectors[27].push_back({-0.26395,0.0021703,23.7177,32.3097});
...
deadvectors[29].push_back({0.509557,0.590004,88.8957,109.384});
deadvectors[29].push_back({1.29495,1.3754,88.8918,109.38});
deadvectors[29].push_back({-1.12327,-1.00839,50.5036,62.039});
deadvectors[30].push_back({-2.63137,-2.34265,32.1209,41.9484});
deadvectors[29].push_back({-1.45991,-1.34507,72.7944,91.2336});
deadvectors[30].push_back({-1.06379,-0.768282,23.371,32.6555});
deadvectors[30].push_back({-0.953477,-0.772774,60.0148,75.795});
deadvectors[31].push_back({2.01827,2.13313,50.5025,62.0375});
deadvectors[32].push_back({1.87395,2.05465,60.0149,75.7949});
deadvectors[32].push_back({-2.89638,-2.6009,23.3724,32.6567});
deadvectors[32].push_back({-2.11099,-1.8155,23.3728,32.6575});
...
deadvectors[31].push_back({1.56948,1.68432,72.7971,91.2369});
deadvectors[31].push_back({1.60911,1.68955,88.9008,109.389});
deadvectors[32].push_back({2.86642,-3.12804,32.1204,41.9479});
deadvectors[31].push_back({2.91587,3.03073,50.5025,62.0376});
deadvectors[31].push_back({-3.10327,-3.02282,88.8888,109.377});
deadvectors[31].push_back({-2.35752,-2.24266,50.504,62.0391});
deadvectors[31].push_back({-1.45992,-1.34505,50.5016,62.0366});
deadvectors[31].push_back({-1.57206,-1.41244,60.5178,75.2913});
...
deadvectors[33].push_back({-2.62012,-2.35405,32.5884,41.483});
deadvectors[34].push_back({-2.52427,-2.34357,60.0177,75.7982});
deadvectors[35].push_back({1.17626,1.33702,39.3365,50.4384});
deadvectors[35].push_back({1.25537,1.41499,60.5163,75.2896});
deadvectors[35].push_back({1.88369,2.04331,60.517,75.2905});
...
deadvectors[36].push_back({-0.168092,0.0126257,60.0158,75.7969});
deadvectors[35].push_back({-2.62012,-2.35405,32.5886,41.4833});
deadvectors[35].push_back({-2.58192,-2.46706,50.5033,62.0384});
...
deadvectors[37].push_back({0.521463,0.787542,32.5874,41.4821});
deadvectors[37].push_back({1.56866,1.83474,32.5873,41.482});
deadvectors[37].push_back({2.39452,2.47497,88.8983,109.387});
deadvectors[37].push_back({-0.982686,-0.902247,88.8986,109.387});
deadvectors[39].push_back({0.469979,0.629596,60.5186,75.292});
...
deadvectors[39].push_back({-1.10082,-0.941197,60.5191,75.2926});
deadvectors[39].push_back({-1.06123,-0.980783,88.9028,109.391});
deadvectors[39].push_back({-0.354365,-0.273932,88.9087,109.397});
...
deadvectors[41].push_back({0.335274,0.45014,50.5037,62.0388});
...
deadvectors[41].push_back({1.34507,1.45992,72.7918,91.231});
deadvectors[41].push_back({2.43287,2.59367,39.336,50.4391});
deadvectors[41].push_back({3.02284,3.10328,88.8973,109.386});
deadvectors[41].push_back({-2.58192,-2.46705,50.5029,62.038});
deadvectors[42].push_back({-1.58181,-1.4011,60.0155,75.7959});
...
deadvectors[44].push_back({-1.11055,-0.929859,60.0172,75.7972});
deadvectors[43].push_back({1.37349,1.45395,88.8915,109.38});
deadvectors[43].push_back({-2.5535,-2.47304,88.9076,109.397});
deadvectors[43].push_back({-1.57206,-1.41244,60.5154,75.2887});
