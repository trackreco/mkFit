...
./mkFit/mkFit --normal-val --read --file-name ${dir}/simtracks_barrel_10x10k_val.bin --build-ce  --num-thr 24 --cloner-single-thread >& log_SNB_ToyMC_Barrel_CE_NVU8int_NTH24_val.txt
