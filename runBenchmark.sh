...
root -b -q makeBenchmarkPlots.C
root -b -q makeBenchmarkPlotsFit.C
...
python makePlotsFromDump.py _host_10x20k_BH_NVU8_NTH21
...
root -b -q makePlotsFromDump.C
sed -i 's/TString test = "BH"/\/\/TString test = \"BH\"/g' makePlotsFromDump.C

python makePlotsFromDump.py _host_10x20k_CE_NVU1_NTH1
python makePlotsFromDump.py _host_10x20k_CE_NVU8_NTH21
...
python makePlotsFromDump.py _host_10x20k_CEST_NVU8_NTH21
...
python makePlotsFromDump.py _host_10x20k_ST_NVU8_NTH21
