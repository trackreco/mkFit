...
do
    ...
    ssh mic0 ./mkFit-mic --read --file-name ${dir}/cmssw_100xTTbarPU35_polar_split_endcapEta1p7.bin --endcap-test --cms-geom --cmssw-seeds --build-comb --seeds-per-task 32 --num-thr 1 --cloner-single-thread >& log_mic_endcap_100xTTbarPU35_COMB_NVU${nvu}_NTH1.txt
