...
do
    ...
    ssh mic0 ./mkFit-mic --read --file-name ${dir}/cmssw_100xTTbarPU35_polar_split_mock_noFWD.bin --cms-geom --cmssw-seeds --build-comb --seeds-per-task 32 --num-thr 1 --cloner-single-thread >& log_knc_100xTTbarPU35_COMB_NVU${nvu}_NTH1.txt
