...
//temporary...
void setupTrackByHand(Point& pos, Vector& mom, SMatrixSym66& covtrk, std::vector<Hit>& hits, int pt) {
  if (pt==1) {
    pos=Point(-4.44741,-1.34288,-0.716961);
    mom=Vector(-0.9199,-0.373767,-0.154805);
    ...
    covtrk*=100;
    Point x1(-4.44738,-1.34304,-0.717461);
    ...
    Hit hit1(x1,covx1);
    Point x2(-7.10575,-2.47484,-1.16735);
    ...
    Hit hit2(x2,covx2);
    Point x3(-9.71576,-3.69152,-1.61728);
    ...
    Hit hit3(x3,covx3);
    Point x4(-21.1287,-10.3726,-3.67952);
