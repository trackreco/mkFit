...
In the CMS HLT, due to its processing time constraints, tracking is run only on selected events.
...
one finds that \mkfit runs about 10-times faster than CMSSW offline tracking.
