...
void makeBenchmarkPlots()
{
  ...
  leg_VU->AddEntry(g_TBB_VU,"TBB-CE","LP");
  ...
  leg_VU_speedup->AddEntry(g_TBB_VU_speedup,"TBB-CE","LP");
  ...
  leg_TH->AddEntry(g_TBB_TH,"TBB-CE","LP");
  ...
  leg_TH_speedup->AddEntry(g_TBB_TH_speedup,"TBB-CE","LP");
